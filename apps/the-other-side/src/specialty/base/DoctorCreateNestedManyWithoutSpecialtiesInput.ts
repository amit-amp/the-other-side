...
@InputType()
class DoctorCreateNestedManyWithoutSpecialtiesInput {
...
export { DoctorCreateNestedManyWithoutSpecialtiesInput as DoctorCreateNestedManyWithoutSpecialtiesInput };
